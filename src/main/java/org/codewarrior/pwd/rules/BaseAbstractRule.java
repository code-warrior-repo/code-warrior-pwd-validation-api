 ...
 */
public abstract class BaseAbstractRule implements BaseRule {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BaseAbstractRule.class);

    BaseAbstractRule(String ruleName, MessageSource messageSource, String messageId, Object[] messageParams) {
