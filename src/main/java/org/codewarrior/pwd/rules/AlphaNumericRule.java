 ...
 */
@Component
public class AlphaNumericRule extends BaseAbstractRule {
    ...
    @Autowired
    public AlphaNumericRule(@Value("${alphanumeric.validation.regex}") String regex, MessageSource messageSource) {
