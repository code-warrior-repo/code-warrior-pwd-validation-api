 ...
 */
@Component
public class CharSequenceRule extends BaseAbstractRule {
    ...
    @Autowired
    public CharSequenceRule(@Value("${charactersequence.validation.regex}") String regex, MessageSource messageSource) {
